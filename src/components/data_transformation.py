...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        try:
            ...
            categoriacal_columns=['gender', 'race/ethnicity', 'parental level of education', 'lunch', 'test preparation course']
            ...
            logging.info(f"Categorical columns: {categoriacal_columns}")
            ...
            preprocessor=ColumnTransformer(
                ...
                ("cat_pipeline",cat_pipeline,categoriacal_columns)
                ]
            )
            return preprocessor
